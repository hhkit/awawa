...
// Same code implemented into glfwCreateWindowSurface, but DiligentEngine create
// vulkan surface inside a ISwapChain implementation and can not use the GLFW
// function.
